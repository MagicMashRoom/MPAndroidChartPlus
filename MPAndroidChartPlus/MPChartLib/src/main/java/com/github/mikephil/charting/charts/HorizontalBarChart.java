...
public class HorizontalBarChart extends BarChart {
    ...
    private Bitmap itemArrow;
    private boolean isDrawItemBitmapArrow = false;
    ...
    protected void init() {
        ...
        XAxisRendererHorizontalBarChart render = (XAxisRendererHorizontalBarChart)mXAxisRenderer;
        render.setAxisLineOffset(38f);
    }
    ...
    public void calculateOffsets() {
        ...
        float minRightOffset = Utils.convertDpToPixel(mMinRightOffset);
        float minLeftOffset = Utils.convertDpToPixel(mMinLeftOffset);

        mViewPortHandler.restrainViewPort(
                Math.max(minLeftOffset, offsetLeft),
                Math.max(minOffset, offsetTop),
                Math.max(minRightOffset, offsetRight),
    ...
    public void setItemArrow(Bitmap bitmap) {
        itemArrow = bitmap;
        isDrawItemBitmapArrow = true;
    }

    public Bitmap getItemArrow() {
        return itemArrow;
    }

    public boolean isDrawItemBitmapArrow() {
        return isDrawItemBitmapArrow;
    }

    public void resetDrawItemBitmapArrow() {
        isDrawItemBitmapArrow = false;
    }
}
