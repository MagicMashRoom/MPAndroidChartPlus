    ...
    protected void drawLinear(Canvas c, ILineDataSet dataSet) {
        ...
        if (dataSet.getColors().size() > 1) {
            ...
            if (e1 != null) {
                ...
                if(dataSet.isDrawDiffLineTypeEnabled()) {
                    ...
                    for (int x = mXBounds.min; x <= mXBounds.range + mXBounds.min; x++) {
                        ...
                        if(e1.isMeaningful() && e2.isMeaningful()) {
                            mRenderPaint.setPathEffect(null);
                            if(j >= 4) {
                                canvas.drawLine(mLineBuffer[j - 4] , mLineBuffer[j - 3] ,
                                        mLineBuffer[j - 2] , mLineBuffer[j - 1] , mRenderPaint);
                            }
                        }
                    }
                }
