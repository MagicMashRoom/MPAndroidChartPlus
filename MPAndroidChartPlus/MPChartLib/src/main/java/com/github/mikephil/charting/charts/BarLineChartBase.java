...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    public float getMinRightOffset() {
        return mMinRightOffset;
    }

    public void setMinRightOffset(float mMinRightOffset) {
        this.mMinRightOffset = mMinRightOffset;
    }

    protected float mMinRightOffset = 15.f;
    ...
    protected float mMinLeftOffset = 15.f;
    /**
    ...
    protected void init() {
        ...
        mChartTouchListener = new BarLineChartTouchListener(this, mViewPortHandler.getMatrixTouch(), 1.34f);
