...
public class XAxisRenderer extends AxisRenderer {
    ...
    private int labelReqLength = 5;
    private String highlightLabel = "";
    private int highlightLabelColor = Color.BLACK;
    ...
    protected void drawLabels(Canvas c, float pos, MPPointF anchor) {
        ...
        for (int i = 0; i < positions.length; i += 2) {
            ...
            if (mViewPortHandler.isInBoundsX(x)) {
                ...
                if(highlightLabel.equals(label)){
                    mAxisLabelPaint.setColor(highlightLabelColor);
    ...
    protected void drawLabel(Canvas c, String formattedLabel,
                             float x, float y, MPPointF anchor, float angleDegrees) {
        //change by ldf
        ...
        if(formattedLabel.length() > 2 * labelReqLength) {
            Utils.drawXAxisValue(c, formattedLabel.substring(0 , labelReqLength),
                    x, y, mAxisLabelPaint, anchor, angleDegrees);
            Utils.drawXAxisValue(c, formattedLabel.substring(labelReqLength , labelReqLength * 2 - 1) + "...",
                    x, y + lineHeight, mAxisLabelPaint, anchor, angleDegrees);
        } else if (formattedLabel.length() > labelReqLength) {
            Utils.drawXAxisValue(c, formattedLabel.substring(0 , labelReqLength),
                    x, y, mAxisLabelPaint, anchor, angleDegrees);
            Utils.drawXAxisValue(c, formattedLabel.substring(labelReqLength , formattedLabel.length()),
                    x, y + lineHeight, mAxisLabelPaint, anchor, angleDegrees);
        } else {
    ...
    // TODO: 16/8/26 添加X轴标签的要求长度,超过此长度会换行
    public void setLabelReqLength(int labelReqLength){
        this.labelReqLength = labelReqLength;
    }
