...
public class XAxisRendererHorizontalBarChart extends XAxisRenderer {
    ...
    public float getAxisLineOffset() {
        return axisLineOffset;
    }

    public void setAxisLineOffset(float axisLineOffset) {
        this.axisLineOffset = axisLineOffset;
    }

    private float axisLineOffset = 0f;
    ...
    protected void computeSize() {
        ...
        final float labelWidth = (int)(labelSize.width + axisLineOffset + mXAxis.getXOffset() * 3.5f);
        final float labelHeight = labelSize.height;

        final FSize labelRotatedSize = Utils.getSizeOfRotatedRectangleByDegrees(
                labelSize.width + axisLineOffset,
                labelHeight,
    ...
    protected void drawLabels(Canvas c, float pos, MPPointF anchor) {
        ...
        for (int i = 0; i < positions.length; i += 2) {
            ...
            if (mViewPortHandler.isInBoundsY(y)) {
                ...
                drawLabel(c, label, pos - axisLineOffset + 6, y, anchor, labelRotationAngleDegrees);
            }
        }
    }
    ...
    public void renderAxisLine(Canvas c) {
        ...
        if (mXAxis.getPosition() == XAxisPosition.BOTTOM
                ...
                || mXAxis.getPosition() == XAxisPosition.BOTH_SIDED) {
            c.drawLine(mViewPortHandler.contentLeft() + axisLineOffset,
                    mViewPortHandler.contentTop(), mViewPortHandler.contentLeft() + axisLineOffset,
                    mViewPortHandler.contentBottom(), mAxisLinePaint);
        }
    }
