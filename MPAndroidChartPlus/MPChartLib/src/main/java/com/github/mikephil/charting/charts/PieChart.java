...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    private float mOuterDecorateRadiusPercent = 5f;

    public float getOuterDecorateRadius() {
        return mOuterDecorateRadiusPercent;
    }

    public void setOuterDecorateRadius(final float percent) {
        mOuterDecorateRadiusPercent = percent;
    }
