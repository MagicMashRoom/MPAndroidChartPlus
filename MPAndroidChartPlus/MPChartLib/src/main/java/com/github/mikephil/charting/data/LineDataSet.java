...
public class LineDataSet extends LineRadarDataSet<Entry> implements ILineDataSet {
    ...
    private boolean mDrawDiffTypeLineEnabled = false;
    ...
    @Override
    public void setDrawDiffLineTypeEnabled() {
        mDrawDiffTypeLineEnabled = true;
    }

    @Override
    public void setDrawDiffLineTypeDisabled() {
        mDrawDiffTypeLineEnabled = false;
    }

    @Override
    public boolean isDrawDiffLineTypeEnabled() {
        return mDrawDiffTypeLineEnabled;
    }
